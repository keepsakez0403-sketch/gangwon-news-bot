...
1. 뉴스 선별 (20~25건 최종 선별):
   ...
   - 제외: 기상, 날씨, 단순 사건/사고, 재난뉴스 등

2. Top 1 핵심 기사 지정 및 대응방안 심층 보고서 작성 ("action_plan"):
   - 수집된 기사 중 강원도정에 파급력이 가장 크거나 대응이 가장 시급한 Top 1 기사를 무조건 1개 지정합니다.(Top 1 기사는 제목에 "사설","시론","발언대","의정칼럼","월요칼럼","대청봉","확대경" 은 일반이슈로 후순위로 해주고 top 1과 현안기사에는 선정하지마)
